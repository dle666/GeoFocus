...
from verl.utils.model_utils import print_gpu_memory_usage, print_model_size
...
from verl.workers.config import ActorConfig, CriticConfig, FSDPConfig, ModelConfig, OptimConfig, RefConfig, WorkerConfig
from verl.workers.critic import DataParallelPPOCritic
from verl.workers.rollout.vllm_rollout import vLLMRollout
from verl.workers.sharding_manager import FSDPVLLMShardingManager
from verl.workers.sharding_manager.fsdp_ulysses import FSDPUlyssesShardingManager

from .rollout import MultiStepvLLMRollout
...
class FSDPWorker(Worker):
    ...
    def _build_rollout(self) -> None:
        ...
        self.rollout = MultiStepvLLMRollout(
    ...
    @register(dispatch_mode=Dispatch.DP_COMPUTE_PROTO)
    def generate_sequences_mss(self, prompts: DataProto) -> DataProto: # mss for treerpo
        assert self._is_rollout
        ...
        with self.rollout_sharding_manager:
            ...
            prompts = self.rollout_sharding_manager.preprocess_data(prompts)
            output = self.rollout.generate_mss_sequences(prompts=prompts)
            output = self.rollout_sharding_manager.postprocess_data(output)
