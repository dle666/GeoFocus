...
class GeoRLHFDataset(Dataset, ImageProcessMixin):
    """
    ...
    def __getitem__(self, index):
        ...
        if self.image_key in row_dict:
            ...
            row_dict["multi_modal_data"] = {"image": images}  # images 就是PIL.Image.Image image mode=RGB size=427x210 at 0x7FC36C3ACFA0
